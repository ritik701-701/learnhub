...
import { Edit, Upload, Link as LinkIcon, X, Image } from 'lucide-react';
    ...
    const fetchCourse = async () => {
      try {
        ...
        if (data.thumbnail) {
          ...
          setImageMode(data.thumbnail.startsWith('http') ? 'url' : 'upload');
        }
      } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
      <h1 className="text-3xl font-bold mb-6 flex items-center">
        <Edit className="mr-2 text-indigo-600 dark:text-indigo-400" /> Edit Course
      </h1>
