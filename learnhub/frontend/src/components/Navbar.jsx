        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          ...
          {user ? (
            <>
              ...
              <Link to={user.role === 'instructor' ? "/instructor" : "/student"} className="px-4 py-2 font-semibold text-gray-700 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                Dashboard
              </Link>
